...
<body>
    ...
    <div class="col-lg-4 mx-auto" id="container">
        ...
        <form action="{{ route('otp.verify') }}" method="post">
            ...
            <p id="countdown-container" class="mt-3">
                Mã có hiệu lực trong vòng <span id="countdown">60</span> giây
            </p>
            <button type="submit" name="btn-authu">Xác thực</button>
        </form>
    </div>

    <script src="{{ asset('assets/js/authu.js') }}"></script>
</body>
