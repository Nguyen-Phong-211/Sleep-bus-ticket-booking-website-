<div id="contact" class="contact">
    <div class="row stats-row gy-4 mt-5 p-4 contact-form" data-aos="fade-up" data-aos-delay="500">
        <form action="{{ route('reservation.findRoute') }}" method="get" class="" id="booking">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 d-flex">
                    <div class="form-check">
                        <input class="form-check-input" value="0" type="radio" name="direct" checked>
                        <label class="form-check-label">
                            Một chiều
                        </label>
                    </div>
                    <div class="form-check ms-4">
                        <input class="form-check-input" value="1" type="radio" name="direct">
                        <label class="form-check-label">
                            Khứ hồi
                        </label>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-6 col-md-12 d-flex justify-content-between mb-3">
                            ...
                            <select name="address_to" id="address-to" class="form-control">
                                ...
                                @foreach ($arrivalPoints as $arrivalPoint)
                                    <option value="{{ $arrivalPoint['arrivalpoint_id'] }}">
                                        {{ $arrivalPoint['arrivalpoint_name'] }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="row mt-4">
                <div class="col text-center">
                    <button type="submit" class="btn"><i class="fa-solid fa-magnifying-glass-location"></i>TÌM
                        CHUYẾN</button>
                </div>
            </div>
        </form>
