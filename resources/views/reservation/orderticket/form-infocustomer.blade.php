                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12 position-relative mb-3">
                                    ...
                                    <input type="text" class="form-control custom-input" name="number_phone" value="{{ Auth::user()->number_phone }}"
                                        placeholder="Số điện thoại" value="{{ old('number_phone') }}">
                                </div>
            
                                <div class="col-md-12 position-relative">
                                    <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                    <input type="email" class="form-control custom-input" name="email" value="{{ Auth::user()->email }}"
                                        placeholder="Email" value="{{ old('email') }}">
                                </div>
                            </div>
